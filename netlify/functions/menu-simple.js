  ...
  try {
    ...
    const sampleMenu = [
      ...
      },
      {
        ...
        price: 100,
        category: 'appetizer',
        ingredients: ['Beans', 'Onions', 'Peppers', 'Oil'],
        allergens: [],
        isVegetarian: true,
        isVegan: true,
        isGlutenFree: true,
      ...
      },
      {
        ...
        price: 100,
        category: 'main-course',
        ingredients: ['Rice', 'Vegetables', 'green pepper', 'yellow pepper', 'Curry', 'Thyme'],
        allergens: [],
        isVegetarian: false,
        isVegan: false,
        isGlutenFree: true,
      ...
      },
      {
        ...
        price: 100,
        category: 'main-course',
        ingredients: ['Brown Beans', 'Plantain', 'Oil', 'Onions', 'Peppers'],
        allergens: [],
        isVegetarian: true,
        isVegan: true,
        isGlutenFree: true,
